 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://data_transmission_using_tpa.mycompany.com/", wsdlLocation = "http://localhost:8080/Data_Transmission_using_TPA/LoginService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://data_transmission_using_tpa.mycompany.com/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Data_Transmission_using_TPA/LoginService?WSDL");
    ...
    public LoginService getLoginServicePort() {
        return super.getPort(new QName("http://data_transmission_using_tpa.mycompany.com/", "LoginServicePort"), LoginService.class);
    }
    ...
    public LoginService getLoginServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://data_transmission_using_tpa.mycompany.com/", "LoginServicePort"), LoginService.class, features);
    }
