                            ...
                            <div class="12u" id="menu">
                                <nav class="mobileUI-site-nav">
                                    <ul>
                                        ...
                                        <li><a href="upload.jsp" class="selected" >File Upload</a> </li>
                ...
                <div class="5grid-layout">
                    <div class="row">
                        <div id="banner" class="12u">
                            <div class="container">  
                                <form action="http://localhost:8084/Data_Transmission_Server1/upload1" method="post" enctype="multipart/form-data">
                                    <center>
                                        <table>
